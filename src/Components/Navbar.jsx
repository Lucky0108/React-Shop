         ...
         <nav className="navbar navbar-expand-lg navbar-light" style={{justifyContent: "space-between"}}>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li className="nav-item dropdown pr-3">
                    ...
                    <NavLink className="dropdown-item" to="/profile"><i className="mr-2 fa fa-user-circle-o" aria-hidden="true"></i> My Profile</NavLink>
                    <div className="dropdown-divider"></div>
                    <NavLink className="dropdown-item" to="/orders"><i className="mr-2 fa fa-first-order" aria-hidden="true"></i> Orders</NavLink>
                    <div className="dropdown-divider"></div>
                    <NavLink className="dropdown-item" to="/wishlist"><i className="mr-2 fa fa-heart" aria-hidden="true"></i> Wishlist</NavLink>
                    <div className="dropdown-divider"></div>
                    <NavLink className="dropdown-item" to="/"><i className="mr-2 fa fa-sign-out" aria-hidden="true"></i> Logout</NavLink>
                    </div>
                </li>
                ...
                <li className="nav-item dropdown pr-3">
                    ...
                    <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                    <NavLink className="dropdown-item" to="/support"><i className="mr-2 fa fa-question-circle" aria-hidden="true"></i> Contact Us</NavLink>
                    <div className="dropdown-divider"></div>
                    <NavLink className="dropdown-item" to="/feedback"><i className="mr-2 fa fa-comments" aria-hidden="true"></i> Drop Feedback</NavLink>
                    </div>
                </li>
